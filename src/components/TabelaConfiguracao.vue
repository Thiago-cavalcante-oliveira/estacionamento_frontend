<template>
  <v-container>
    <v-data-table :headers="headers" :items="object" :sort-by="[{ key: 'id', order: 'asc' }]" class="elevation-1">
      <template v-slot:top>
        <v-toolbar flat>
                ...
                <v-container>
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" sm="4" md="4">
                      <v-text-field v-mask="'##:##'" v-model="editedItem.inicioExpediente" label="Horário de abertura"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
                      <v-text-field v-mask="'##:##'" v-model="editedItem.fimExpediente" label="Horário de encerramento"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
